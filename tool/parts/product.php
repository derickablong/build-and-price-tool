...
?>
<div class="product-item" data-product="<?php echo $post->ID ?>" data-reg-price="<?php echo $product->get_price() ?>" data-sale-price="<?php echo $product->get_sale_price() ? $product->get_sale_price() : '0' ?>">        
